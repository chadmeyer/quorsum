...
$2^{16} 64!/(64-4)! = 999,360,036,864 \sim 1\mathrm{ trillion}$.  Good luck
finding a machine to store a trillion by trillion matrix, let alone invert it.
Of course, many of the states are completely inaccessable for a given board and
strategy, but nevertheless, a full analysis of the system is cumbersome.
